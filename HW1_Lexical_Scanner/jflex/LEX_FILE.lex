...
TYPE_STRING       = string
TYPE_VOID         = void
NoSSComment   = ({DIGIT}|{LETTER}|{WhiteSpace}|\(|\)|\[|\]|\{|\}|\!|\?|\+|\-|\.|\;)
NoStarComment   = ({DIGIT}|{LETTER}|{WhiteSpace}|\(|\)|\[|\]|\{|\}|\!|\?|\+|\-|\/|\.|\;)*
CharsForComment   = [a-zA-Z0-9\(\)\[\]\{\}?!+\-.; \t\f]
ErrorSingleComment = "//" [^\r\n]*
SingleComment     = "//"({CharsForComment} | "/"| "*")*
StarComment 	  = \/\*((\*+{NoSSComment}+)|{NoStarComment})*\**\*\/
ErrorComment    = \/\*
/******************************/
/* DOLAR DOLAR - DON'T TOUCH! */
/******************************/
...
{StarComment}		{ /* just skip what was found, do nothing */ }
{ErrorSingleComment} { return symbol(TokenNames.ERROR); }
